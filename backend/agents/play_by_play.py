# backend/agents/play_by_play.py
# Play-by-play agent: narrates live action with excitement scaled to priority.

from __future__ import annotations

from agents.base import BaseAgent, _events_to_text, _state_to_summary
from agents.prompts import build_pbp_system, build_pbp_prompt
...
class PlayByPlayAgent(BaseAgent):
    ...
    def _fallback(self, events: list[MatchEvent], state: SharedMatchState) -> str:
        ...
        from spatial.converter import coords_to_description
